...
public class Juego {
    ...
    public void iniciar() {
        ...
        // Mostrar jugadores y sus manos iniciales
        ...
        Carta primeraCarta = baraja.tomarCarta();
        if (primeraCarta != null) {
            mazoDescarte.agregarCarta(primeraCarta);
            System.out.println("\nCarta inicial en el mazo de descarte: " 
                    + primeraCarta.getColorActual() + " " 
                    + (primeraCarta.getAccionActual() != null ? primeraCarta.getAccionActual() : primeraCarta.getValorActual()));
        }
